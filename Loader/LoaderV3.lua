...
repeat
    task.wait()
until game:IsLoaded() and game:GetService("Players") and game:GetService("Players").LocalPlayer and
...
if not isLoad then
    ...
    title.Text = "NoLag HUB Key System"
    ...
    local inputkeyButton = Instance.new("TextButton")
    inputkeyButton.Name = "inputkeyButton"
    inputkeyButton.Size = UDim2.new(1, 0, 0, 45)
    ...
    buttonHoverEffect(inputkeyButton)
    ...
    keyButton.MouseButton1Click:Connect(
        function()
            ...
            keyFrame.Size = UDim2.new(0, 350, 0, 250) -- Increased height to accommodate new button
            ...
            keyTitle.Text = "[No Lag] Select Checkpoint Link"
            ...
            lootlabsButton.Position = UDim2.new(0, 20, 0, 70) -- Adjusted position
            ...
            linkVertiseButton.Position = UDim2.new(0, 20, 0, 120) -- Adjusted position
            ...
            rinkuButton.Position = UDim2.new(0, 20, 0, 170)

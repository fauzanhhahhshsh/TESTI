local data = {
  ...
  crate = {"Mysterious Crate", "Sign Crate", "Common Gnome Crate", "Farmers Gnome Crate", "Fun Crate", "Classic Gnome Crate", "Statue Crate", "Beach Crate", "Summer Fun Crate", "Oasis Crate", "Exclusive Cosmetic Crate", "Twilight Crate", "July 4th Crate", "Bloodmoon Crate", "Bee Crate", "Honey Crafters Crate", "Iconic Gnome Crate"},
  egg = { "Anti Bee Egg", "Bee Egg", "Bug Egg", "Common Egg", "Common Summer Egg", "Divine Egg", "Epic Egg", "Exotic Bug Egg", "Legendary Egg", "Mythical Egg", "Night Egg", "Paradise Egg", "Premium Anti Bee Egg", "Rare Egg", "Rare Summer Egg", "Uncommon Egg", "Oasis Egg" },
